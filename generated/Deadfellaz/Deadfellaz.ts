...
export class Deadfellaz extends ethereum.SmartContract {
  static bind(address: Address): Deadfellaz {
    return new Deadfellaz("Deadfellaz", address);
  }

  MAX_MINT_AMOUNT(): BigInt {
    let result = super.call(
      "MAX_MINT_AMOUNT",
      "MAX_MINT_AMOUNT():(uint256)",
      []
    );
  ...
  try_MAX_MINT_AMOUNT(): ethereum.CallResult<BigInt> {
  ...
  MAX_PRIZE_MINTS(): BigInt {
    let result = super.call(
      "MAX_PRIZE_MINTS",
      "MAX_PRIZE_MINTS():(uint256)",
      []
    );
  ...
  try_MAX_PRIZE_MINTS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "MAX_PRIZE_MINTS",
      "MAX_PRIZE_MINTS():(uint256)",
      []
...
export class MintPrizesCall extends ethereum.Call {
  get inputs(): MintPrizesCall__Inputs {
    return new MintPrizesCall__Inputs(this);
  }

  get outputs(): MintPrizesCall__Outputs {
    return new MintPrizesCall__Outputs(this);
  }
}

export class MintPrizesCall__Inputs {
  _call: MintPrizesCall;

  constructor(call: MintPrizesCall) {
    this._call = call;
  }
...
export class MintPrizesCall__Outputs {
  _call: MintPrizesCall;
